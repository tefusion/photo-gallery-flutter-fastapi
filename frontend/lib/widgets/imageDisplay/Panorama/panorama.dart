//cloned from https://github.com/zesage/panorama

//for adding desktop compatibility and smaller bug fixes
...
class _PanoramaState extends State<Panorama>
  ...
  Widget build(BuildContext context) {
    ...
    Widget panoView = GestureDetector(
      ...
      return Listener(
          onPointerSignal: (pointerSignal) {
            if (pointerSignal is PointerScrollEvent) {
              scene.camera.zoom -= pointerSignal.scrollDelta.dy / 300;
              _controller.forward();
            }
          },
          child: widget.interactive ? panoView : pano);
    } else {
      return widget.interactive ? panoView : pano;
    }
  }
}
